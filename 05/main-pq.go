...
// 	fmt.Println(pq)
// 	fmt.Println(uls)
// 	fmt.Println(isValidUpdateList(uls[0], &pq))
// }

// // Reads the input file
// func readInput(fname string) (PriorityQueue, [][]int, error) {
...
// func isValidUpdateList(ul []int, pq *PriorityQueue) bool {
// 	for pq.Len() > 0 {
// 		p := pq.Pop().(*protocol)
// 		fmt.Printf("Value: %d, Priority: %d Index: %d\n", p.page, p.priority, p.index)
// 	}
// 	return true
// }
